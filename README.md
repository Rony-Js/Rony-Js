...
<p align="center">
  ...
  <a href="ronelvys.fuentes.dominet@gmail.com">
...
- **2023**
  ...
  - ⋄ Medalla de Plata en la Copa UCI
  - ⋄ Participé en el ICPC Qualifier
  - ⋄ Participé en la Copa Regional IPVCE.
- **2024**
  - ⋄ Medalla de Oro en el concuro provincial
  - ⋄ Obtención del Primer Puesto en la Jornada de Sociedades Científicas con un proyecto de robotica basado en materiales reciclables.
  - ⋄ Obtencion del Segundo Puesto nacional con el mismo proyecto en la Jornada de Sociedades Científicas nacional.
  - ⋄ Medalla de Plata en el concurso nacional de informática
  - ⋄ Preselección nacional de informática
  - ⋄ Medalla de Plata en la Copa UCI
  - ⋄ Participé en la Olimpiada Internacional de TI
  - ⋄ Mención en la Olimpiada Internacional de TI
- **2025**
  - ⋄ Participé en el ICPC Qualifier
  - ⋄ Medalla de Oro en el concurso provincial
  - ⋄ Ejecucion exitosa del Primer proyecto independiente y privado basado en el aprendisaje y la informatica en la ciudad de Cárdenas.
  - ⋄ Preselección nacional de informática
